...
function getControls(){
	...
	//Directional inputs
	keyRight = keyboard_check(vk_right) + gamepad_button_check(4, gp_padr);
	keyLeft = keyboard_check(vk_left) + gamepad_button_check(4, gp_padl);
	keyDown = keyboard_check(vk_down) + gamepad_button_check( 4, gp_padd )
	keyUp = keyboard_check(vk_up) + gamepad_button_check( 4, gp_padu );
	
	keyJump = keyboard_check_pressed(vk_space) + gamepad_button_check_pressed(4, gp_face1)
	...
	key_jump_held = keyboard_check(vk_space) + gamepad_button_check(4, gp_face1);
