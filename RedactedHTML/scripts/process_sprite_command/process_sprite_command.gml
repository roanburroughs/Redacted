...
function process_sprite_command(command_line) {
    ...
    // Extract slot number (e.g., "1" from "character slot1")
    ...
    // Remove "slot" prefix if present and get just the number
    ...
    // Find the character slot object and update its sprite
